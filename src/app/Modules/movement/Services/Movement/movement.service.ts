...
export class MovementService {
  ...
  async insert(pMovement: Movement): Promise<ResponseApi> {
    ...
    return this.http
      .post<ResponseApi>(urlInsert, pMovement, this.HttpOptions)
      .toPromise()
  }
  ...
  async update(pMovement: Movement): Promise<ResponseApi> {
    ...
    return this.http
      .post<ResponseApi>(urlUpdate, pMovement, this.HttpOptions)
      .toPromise()
  }
  ...
  async delete(pMovement: Movement): Promise<ResponseApi> {
    ...
    return this.http
      .post<ResponseApi>(urlDelete, pMovement, this.HttpOptions)
      .toPromise()
  }
}
