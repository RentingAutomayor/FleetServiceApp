...
export class ContractualInformationComponent implements OnInit {
  ...
  setDataContractualInformation(event: any): void {
    ...
    this.contractualInformation.quotaType = this.quotaTypes.find(
      (qt) => qt.id == this.contractualInformation.quotaTypeId
    )
  ...
  validateQuotaDates() {
    this.validateQuotaEndDate(
      this.quotaApprovalDateTmp,
      this.quotaEndingDateTmp
    )
  }
