...
export interface CreateContractualInformationDTO
  extends Omit<ContractualInformation, 'id' | 'QuotaType'> {
  quotaTypeId: number
}

export interface ContractualInformationDTO
  extends Partial<CreateContractualInformationDTO> {}
