...
export class ClientComponent implements OnInit {
  ...
  isBasicDataCompleted: boolean= false;
  areContactCompleted: boolean= true;
  areBranchCompleted: boolean = true;
  areVehiclesCompleted: boolean = true;
  isContractualInfoSetted: boolean = false;
  isButtonSaveClientVisible:boolean = true;
      ...
      if (this.clientID){
        ...
        .then(client => {
          if (client != null){
            ...
            this.quotaApproved = this.client.financialInformation.approvedQuota;
  ...
  async updateContractualInformation(contractualInfo: ContractualInformation){
    const idContractualInformation = (this.contractualInformation)?this.contractualInformation.id:0;
  ...
  prevStepContractualInfo(){
    const btnPrevStep = document.getElementById('btn-prev-step-contractual-info');
    btnPrevStep.click();
  }
